// src/pages/ServiceLocation/AvailabilityPage.tsx
...
export default function ServiceLocationAvailabilityPage() {
  ...
  useEffect(() => {
    ...
    store.getByScope('location', serviceLocationId).then((doc) => {
      if (doc) setData(doc);
      else
        setData({
          scope: 'location',
          scopeId: serviceLocationId,
