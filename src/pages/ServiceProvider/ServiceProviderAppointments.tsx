...
export default function ServiceProviderAppointments() {
  ...
  // STORES
  const apptStore = useMemo(
    () => new FirestoreAppointmentStore(),
    []
  )
  const clientStore = useMemo(
    () => new FirestoreClientStore(),
    []
  )
  ...
  // 2) reload all of your appointments + dropdown data
  ...
  return (
    <Box>
      ...
      <AppointmentFormDialog
        open={dialogOpen}
        serviceLocationId={
          appointments[0]?.serviceLocationIds?.[0] || ''
        }
